...
# PS1 is similar to html tags but with color. This is an open tag \[\e[0;32m] and this is a closing tag \[\e[0m\]

# \[\e[0;32m] bla bla \[\e[0m\] 0;32 is color green, space is \[$(tput sgr0)\], \W current dir and so on...
